  ...
  WUL.station({
    ...
    build: [
      ...
      { type: 'rules', id: 'pvalue', title: 'What the p-value means', items: [
        { t: '__Pretend:__ the independent variable does nothing, so any difference you found is just chance. This is the [[null hypothesis]].', icon: '1' },
        { t: '__Check:__ in that pretend world, how often would chance alone give a difference as big as the one you found? That number is the **p-value**.', icon: '2' },
