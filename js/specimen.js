...
(function (WUL) {
  ...
  var P = {
    ...
    e: { name: 'IB Extended Essay', len: '4,000 words max', parts: [
      ...
      { n: 'Analysis', st: 'stats', crit: 'C Analysis', tx: 'A t-test between 40 °C and 50 °C gave t = 5.77, df = 8, p < 0.001, so the shorter time at 50 °C is statistically significant…', job: 'Analysis that produces relevant findings, with statistics where appropriate, inside the analysis.', lose: 'Numbers with no line of argument linking them to the question.', chg: 'The analysis must build an argument, and the statistics are part of it.' },
