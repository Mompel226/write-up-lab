...
(function (WUL) {
  ...
  var P = {
    ...
    i: { name: 'IB Internal Assessment', len: '3,000 words max', parts: [
      ...
      { n: 'Analysis', st: 'analysis', crit: 'Data analysis', tx: 'The SD bars at 40, 50 and 60 °C do not overlap, which suggests the minimum at 50 °C is not due to chance…', job: 'Trend and key values, plus what the uncertainty allows you to claim. A statistical test is optional.', lose: 'Claiming a difference, or no difference, from overlapping error bars alone.', chg: 'Uncertainty now shapes the claim.' },
