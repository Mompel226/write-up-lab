...
(function (WUL) {
  ...
  var P = {
    ...
    i: { name: 'IB Internal Assessment', len: '3,000 words max', parts: [
      ...
      { n: 'Analysis', st: 'analysis', crit: 'Data analysis', tx: 'The SD bars at 40, 50 and 60 °C do not overlap. A t-test between 40 °C and 50 °C gave t = 5.77, df = 8, p < 0.001, so the shorter time at 50 °C is unlikely to be due to chance…', job: 'Trend and key values, what the uncertainty allows you to claim, and the statistical test with its result. The test goes here, inside the analysis.', lose: 'Claiming a difference, or no difference, from overlapping error bars alone.', chg: 'Uncertainty and a statistical test now shape the claim.' },
    ...
    e: { name: 'IB Extended Essay', len: '4,000 words max', parts: [
      ...
      { n: 'Analysis', st: 'stats', crit: 'C Analysis', tx: 'A t-test between 40 °C and 50 °C gave t = 5.77, df = 8, p < 0.001, so the shorter time at 50 °C is unlikely to be due to chance…', job: 'Analysis that produces relevant findings, with statistics where appropriate, inside the analysis.', lose: 'Numbers with no line of argument linking them to the question.', chg: 'The analysis must build an argument, and the statistics are part of it.' },
  ...
  var R = [
    ...
    { page: 2, id: 'stats', st: 'stats', lv: 'ie', name: 'Statistics', kind: 'lines',
      iTxt: '**Not required by the IA criteria, but it shows whether a difference or a trend could be just chance.** Choose the test that fits your data: a t-test for two groups, χ² for counts in categories, a correlation for a straight-line trend (more than two groups: see *Find your test*). State the null hypothesis, report the test value, df and p, and say in one sentence what it means: evidence, never proof. In your report it has no section of its own: it goes inside your __data analysis__.',
      e: 'Analysis', eTxt: 'In the EE, use statistics where appropriate, and justify the choice of test. They go inside your __analysis__, as a step in the argument.' },
    { page: 2, id: 'analysis', st: 'analysis', name: 'Data analysis', kind: 'lines', g: 'Data analysis', i: 'Analysis',
      iTxt: 'The IGCSE parts, then two more: what the error bars allow you to claim, and your __statistical test__. The test goes here, inside the data analysis: there is no separate statistics section.',
      eTxt: 'Your analysis must build an argument that leads to the answer to your research question. Statistics, where appropriate, go here too, as a step in that argument.' },
