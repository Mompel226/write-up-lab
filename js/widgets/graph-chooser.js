  ...
  function cards() {
    ...
    return [
      ...
      { id: 'amylase', ans: 'line',
        ...
        why: 'Temperature is a [[continuous variable]], and its values were set. Plot each mean as a cross and join the crosses with ruled lines.',
        spec: { x: { min: 20, max: 60, step: 10, minor: 5, label: 'Temperature / °C' }, y: { min: 0, max: 200, step: 50, minor: 5, label: 'Mean time / s' }, series: [{ id: 'm', pts: xy(D.temps, D.means), line: 'ruled' }] } },
      { id: 'holly', ans: 'hist',
      ...
      { id: 'potato', ans: 'line',
        ...
        why: 'Concentration is continuous, and its values were chosen. The negative changes are plotted below zero on the y-axis.',
        spec: { x: { min: 0, max: 0.5, step: 0.1, minor: 5, label: 'Concentration of sucrose / mol dm⁻³' }, y: { min: -15, max: 15, step: 5, minor: 5, label: 'Change in mass / %', fmt: minus }, tickDpX: 1, series: [{ id: 'm', pts: xy(potX, potY), line: 'ruled' }] } },
      { id: 'beans', ans: 'hist',
